...
const serviceCategories = [
    ...
    items: [
      {
        ...
        description: '국내외 특허 및 실용신안의 전략적 출원을 통해 기술 자산을 보호하고 강력한 독점 권리를 확보합니다. 엔지니어와 같은 언어로 기술을 이해하고 아이디어 단계부터 강력한 IP를 설계합니다.'
      },
      {
        name: '상표/디자인 출원 및 등록',
  ...
  },
  {
    ...
    items: [
      {
        name: '특허 발굴',
        description: '비즈니스 곳곳에 숨어 있는 기술 아이디어를 찾아내어 권리화와 확장으로 연결합니다. 개발 단계마다 기술의 본질을 분석하고, 특허 가능성이 높은 요소를 선별·체계화합니다. 이를 바탕으로 특허 장벽을 구축하여 경쟁사가 쉽게 침투할 수 없는 기술 방어선을 만듭니다.'
      },
      {
        name: '로드맵 설계',
    ...
    items: [
      {
        ...
        description: '디딤돌, IP나래, TIPS, 수출 바우처 등 각종 정부 지원 사업의 선정 가능성을 높이기 위해 기술성과 사업성이 조화된 맞춤형 사업계획서 작성을 지원합니다.'
      },
      {
        name: '고객 특화의 IP 과제 알림 지원',
        description: '기업의 기술 분야와 성장 단계에 최적화된 정부 지원 과제를 상시 수집하고, 고객사에 부합하는 최적의 사업을 선별하여 실시간으로 안내해 드립니다.'
      }
    ]
  }
];
...
export const Services: React.FC = () => {
  return (
    <section id="services" className="py-20 md:py-32 bg-[#F9F9F9]">
                  ...
                  {category.items.map((item, itemIdx) => (
                    <div key={itemIdx} className="group flex gap-4 md:gap-8">
                      ...
                      <div className="flex-1">
                        <h4 className="text-lg md:text-xl font-black text-[#1F2F6E] mb-2 md:mb-4 group-hover:text-[#FF5A00] transition-colors duration-300">
                          {item.name}
                        </h4>
